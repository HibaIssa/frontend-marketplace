...
export default function AdminOverviewPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-2xl border border-black/10 bg-white p-5 sm:p-6 space-y-4 shadow-sm ring-1 ring-black/5">
        <div>
        ...
        <div className="rounded-xl border border-black/10 bg-[#e5eeff]/30 p-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {groupCounts.map(({ group, count, href, Icon }) => (
            <Link
              key={group}
              href={href}
              className="rounded-xl border border-black/10 bg-white p-3.5 hover:bg-[#e5eeff]/40 hover:border-black/20 hover:shadow-sm transition-all"
            >
              <div className="flex items-start gap-3">
                <span className="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#e5eeff] text-[#0a0a0a] ring-1 ring-black/10">
