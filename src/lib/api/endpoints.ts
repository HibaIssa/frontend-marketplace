...
export const endpoints = {
  ...
  images: {
    search: '/search/image/alt',
    searchSelective: '/search/image/alt/selective',
    searchUrl: '/search/image/url',
    analyze: '/search/analyze',
    detect: '/search/detect',
    detectUrl: '/search/detect/url',
    detectBatch: '/search/detect/batch',
  ...
  /** Catalog quality dashboard — Cloud routes use `/admin/*` (admin JWT). */
  adminCatalog: {
