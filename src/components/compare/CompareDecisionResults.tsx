              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-1 flex items-start gap-2">
                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-violet-600 to-fuchsia-500 text-xs font-bold text-white shadow-sm">
                      {letter}
                    </span>
              ...
              {attraction.scores.map((s) => {
                ...
                return (
                  <span key={s.productId} className="text-sm text-neutral-700 max-w-[min(100%,22rem)]">
                    <span className="font-mono font-bold text-violet-700">{letter}</span>
            ...
            <div>
              ...
              <ul className="text-sm space-y-1">
                {result.outfitImpact.versatilityScores?.map((v) => (
                  <li key={v.productId}>
                    <span className="font-mono font-semibold text-violet-700">{productLetter(ids, v.productId)}</span>
                    <span className="text-neutral-500">: </span>
