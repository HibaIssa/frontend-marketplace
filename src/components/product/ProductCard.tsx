      ...
      <div className="mt-3 px-0.5">
          <div className="flex items-center justify-between gap-3">
            <Link
              ...
              prefetch={fromReturnPath ? false : undefined}
              onClick={() => saveListingScrollY(fromReturnPath, typeof window !== 'undefined' ? window.scrollY : 0)}
              className="font-sans text-[15px] sm:text-[16px] font-semibold leading-[1.35] text-ink line-clamp-2 min-w-0 pr-1 hover:underline underline-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/35 rounded-sm"
            >
              {product.title}
            </Link>
            ...
            <p className="mt-1 text-small text-muted/90 line-clamp-2 font-sans">
              {product.brand ? (
                <Link
                  ...
                  prefetch={fromReturnPath ? false : undefined}
                  onClick={() => saveListingScrollY(fromReturnPath, typeof window !== 'undefined' ? window.scrollY : 0)}
                  className="font-medium text-ink/90 underline-offset-2 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/35 rounded-sm"
                >
                  {product.brand}
                </Link>
              ) : null}
